...
./../../../bin/HFO --port 2207 --headless --defense-agents=2 --offense-agents=1 --offense-on-ball 11 --trials 5001 --deterministic --discrete=True --frames-per-trial 2000 --untouched-time 2000 &
sleep 5
