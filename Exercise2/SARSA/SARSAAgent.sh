...
./../../../bin/HFO --port 2207 --defense-agents=2 --offense-agents=1 --offense-on-ball 11 --trials 5001 --headless --deterministic --discrete=True --frames-per-trial 2000 --untouched-time 2000 &
sleep 5
...
sleep 5
./DiscreteHFO/Goalkeeper.py --port 2207 --numEpisodes=5000 >/dev/null 2>&1 &
